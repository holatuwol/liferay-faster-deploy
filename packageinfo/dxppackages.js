	...
	if (this.readyState == 4 && this.status == 200) {
		...
		if (sourceVersionFilter && targetVersionFilter) {
			...
			sourceVersionFilter.onchange = function() {
				applyVersionFilter(sourceVersionFilter, select1, fixPackIds, addFixPack, setIndex, checkPackageInfo);
			};

			targetVersionFilter.onchange = function() {
				applyVersionFilter(targetVersionFilter, select2, fixPackIds, addFixPack, setIndex, checkPackageInfo);
			};
		}
